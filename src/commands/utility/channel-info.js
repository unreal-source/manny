  ...
  async run (interaction) {
    ...
    if (channel.isText()) {
      ...
      if (channel.lastMessage) {
        info.addField('Latest Activity', `${time(channel.lastMessage.editedAt || channel.lastMessage.createdAt)} • ${time(channel.lastMessage.editedAt || channel.lastMessage.createdAt, 'R')}`)
      }
    }
