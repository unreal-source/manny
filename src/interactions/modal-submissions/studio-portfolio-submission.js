...
class StudioPortfolioSubmission extends ModalSubmission {
  ...
  async run (interaction) {
    ...
    const channel = interaction.guild.channels.cache.get(process.env.STUDIO_PORTFOLIO_CHANNEL)
...
export default StudioPortfolioSubmission
