...
class FreelanceJobSubmission extends ModalSubmission {
  constructor () {
    super({
      id: 'freelanceJobModal'
    })
  }
  ...
  async run (interaction) {
    ...
    const channel = interaction.guild.channels.cache.get(process.env.FREELANCE_JOB_CHANNEL)
...
export default FreelanceJobSubmission
